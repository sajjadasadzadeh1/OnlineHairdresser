                                ...
                                <tbody>
                                   ...
                                   include 'db.php';
                                    ...
                                    while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <td>" . $row["Cost"]. "</td>
                                        <td>
                                        <a href='UpdateProficiency.php?id=" . $row["proficiency_id"]. "&& profttl=" . $row["proficiencyTitle"]. " && cost=" . $row["Cost"]. "'>ویرایش</a>
                                        <a href='deleteProficiency.php?id=" . $row["proficiency_id"]. "'>حذف</a>
                                        </td>
                                        </tr>";
                                        $i++;
                                    }
