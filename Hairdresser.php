                 ...
                 <div class="card-body">
                          ...
                          <div class="col-md-10 text-center"  style="min-height:350px !important;">
                              <div class="card w-25">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control form-control-sm" name="HairdresserFullname">
                                 </div>
                                 <div class="form-group">
                                     ...
                                     <select class="form-control form-control-sm" name="proficiency">
                                         ...
                                         while($row = mysqli_fetch_assoc($result)) {
                                            echo "<option value='". $row["proficiency_id"]. "'>". $row["proficiencyTitle"]. "</option>";    
                                            
                                         }
                                         } else {
                                         echo "هیج خدماتی ثبت نشده است";
                                         }
                                         ?>
                                     </select>
                                 </div>
                     ...
                     <?php
                            ...
                            if (isset($_POST['submit'])){
                                ...
                                if(!empty($_POST['HairdresserFullname']) && !empty($_POST['proficiency'])){

                                    $HairdresserFullname=$_POST['HairdresserFullname'];
                                    $proficiency=$_POST['proficiency'];
                                    

                                    $query="insert into hairdresser (Hairdresser_id,HairdresserFullName,proficiency_id) values('','$HairdresserFullname','$proficiency')" ;
